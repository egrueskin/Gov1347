...
## Predictions
In my nationwide two-party voteshare model, I forecasted that Republicans would receive 52.5% of the vote and Democrats would receive 47.5% of the vote. My 95% prediction interval, which accounts for simulations of 100 times, stretched about 3.4 percentage points in either direction, signifying that in 95% of the simulations, Democrats would get anywhere from 47.4 to 50.8% of the national vote. 
