...
errors will be diluted. Here, I begin to look at seat share versus fundamental data (presidential party, house incumbency party), economic data (disposable change in income), as well as presidential and generic ballot approval ratings. I subset to only midterm years
...
lm2<-lm(seats~party*president_party*H_incumbent_party+DSPIC_change_pct+approval+poll_pct,data=all)

stargazer(lm1,lm2,type='text')
```

Through these initial results, it appears as though controlling for the interactions between
the party, president party, and house incumbent party add more nuance and better predictions
to my model. However, many of the coefficients are not as I'd expect, so I will delve
further into examining confounders or lack of data.
