...
In this blog post, I am examining how unemployment rates and affect voting patterns 
for House races in the United States.

*Data* 

I use three datasets: Unemployment by state, popular voting by house (state level), and a national
dataset with presidential incumbent information.
National: unemployment nationally and voting by house nationally
...
Additionally, the mean squared error was at 0.004 for this model.
